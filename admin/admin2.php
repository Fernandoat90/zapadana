...
.inputBasics{
    ...
    <div id="cabecera">
            ...
            <p style="color:black">Calzado<select required name="cal_id" id="">
            ...
            <p style="color:black;"><br>Url de la imagen:<input required  class="inputBasics" type="text" value="<?php echo $stock_img ?>" name="stock_img"></p> <br>
            
            <p style="display:none;">Cal_id :</p> <input style="display:none;" class="inputBasics" name="cal_id" type="number" step=1 value=<?php echo $cal_id; ?>> <br>
        
            <p style="color:black">Precio:</p> <input class="inputBasics" name="cal_precio" type="number" min=1 step=0.01 value=<?php echo $cal_precio; ?>> <br>
            ...
            <p style="color:black; margin-bottom:2%;">Color:<input style="display:none;" type="number" value="<?php echo $color_id ?>" name="color_id">
            ...
            <p style="color:black;" >Talle 35:<input max=99 required min=0 class="inputBasics" type="number" value="<?php echo $n_35 ?>" name="n_35"></p> <br>
            
            <p style="color:black;" >Talle 36:<input max=99 required min=0 class="inputBasics" type="number" value="<?php echo $n_36 ?>" name="n_36"></p> <br>
            
            <p style="color:black;" >Talle 37:<input max=99 required min=0 class="inputBasics" type="number" value="<?php echo $n_37 ?>" name="n_37"></p> <br>
            
            <p style="color:black;" >Talle 38:<input max=99 required min=0 class="inputBasics" type="number" value="<?php echo $n_38 ?>" name="n_38"></p> <br>
            
            <p style="color:black;" >Talle 39:<input max=99 required min=0 class="inputBasics" type="number" value="<?php echo $n_39 ?>" name="n_39"></p> <br>
            
            <p style="color:black;" >Talle 40:<input max=99 required min=0 class="inputBasics" type="number" value="<?php echo $n_40 ?>" name="n_40"></p> <br>
            
            <p style="color:black;" >Talle 41:<input max=99 required min=0 class="inputBasics" type="number" value="<?php echo $n_41 ?>" name="n_41"></p> <br> 
            
            <p style="color:black;" >Talle 42:<input max=99 required min=0 class="inputBasics" type="number" value="<?php echo $n_42 ?>" name="n_42"></p> <br>
            
            <p style="color:black;" >Talle 43:<input max=99 required min=0 class="inputBasics" type="number" value="<?php echo $n_43 ?>" name="n_43"></p> <br>
            
            <p style="color:black;" >Talle 44:<input max=99 required min=0 class="inputBasics" type="number" value="<?php echo $n_44 ?>" name="n_44"></p> <br>
            
            <p style="color:black;" >Talle 45:<input max=99 required min=0 class="inputBasics" type="number" value="<?php echo $n_45 ?>" name="n_45"></p> <br>
            
            <div style="margin:center"> 
            
            <input style="margin:0 auto" class="botonSubmit" type="submit"  formaction="./admin2.php" formmethod="post"  value="Editar Stock" >
            
            <input style="margin:0 auto" class="botonSubmit" type="submit" value="Home" formaction="admin.php" formmethod="get">
