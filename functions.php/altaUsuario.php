...
if (mysqli_affected_rows($conection) > 0) {
    ...
    header("location:./../register.php?usuarioExistente"); // DONDE ESTA ESTO DAJKSDJKASJD

    //$hash = password_hash($pass, PASSWORD_DEFAULT);

} else {

    if ($pass2 == $pass) { // ??? ah ya entendí
     ...
     VALUES ('$nom','$ape','$dir','$mail','$pass','$id')";
            ...
            if (mysqli_affected_rows($c) > 0) {
                header("location:./../login.php?valida"); // DONDE ESTA ESTO DAJKSDJKASJD
